...
describe("gateway protocol", () => {
  ...
  test("loads only enabled and available skills", async () => {
    ...
    try {
      void gr_check(authorization, "skill_manifest", "skill_check", "", 5000, { candidate_policies: ["AI_SKILL_DAT_SEC_001", "AI_SKILL_SEC_001", "AI_SKILL_SEC_002", "AI_SKILL_SEC_003"] }).catch((_grExc) => {
